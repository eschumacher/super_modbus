...
class TcpSlave {
 public:
  explicit TcpSlave(uint8_t unit_id)
      : id_(unit_id) {}
 ...
 private:
  ...
  static void ProcessReadRegisters(const AddressMap<int16_t> &address_map, const TcpRequest &request,
                                   TcpResponse &response);
  static void ProcessWriteSingleRegister(AddressMap<int16_t> &address_map, const TcpRequest &request,
                                         TcpResponse &response);
  static void ProcessReadCoils(const AddressMap<bool> &address_map, const TcpRequest &request, TcpResponse &response);
  static void ProcessWriteSingleCoil(AddressMap<bool> &address_map, const TcpRequest &request, TcpResponse &response);
  static void ProcessWriteMultipleRegisters(AddressMap<int16_t> &address_map, const TcpRequest &request,
                                            TcpResponse &response);
  static void ProcessWriteMultipleCoils(AddressMap<bool> &address_map, const TcpRequest &request,
                                        TcpResponse &response);
  void ProcessReadExceptionStatus(const TcpRequest &request, TcpResponse &response) const;
  static void ProcessDiagnostics(const TcpRequest &request, TcpResponse &response);
  ...
  static void ProcessMaskWriteRegister(AddressMap<int16_t> &address_map, const TcpRequest &request,
                                       TcpResponse &response);
  static void ProcessReadWriteMultipleRegisters(AddressMap<int16_t> &address_map, const TcpRequest &request,
                                                TcpResponse &response);
